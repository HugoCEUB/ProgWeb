...
/**
 * Servlet implementation class ServLetela1Cadastro
 */
@WebServlet("/ServLetela1Cadastro")
public class ServLetela1Cadastro extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ServLetela1Cadastro() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		resposta.write("Empresa:<input type=\"text\" name=\"emresa\"> <BR>");
